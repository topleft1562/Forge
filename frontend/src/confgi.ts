...
export const cluster = process.env.NEXT_PUBLIC_CHAIN ?? 'mainnet-beta'
...
export const ADMINKEY = process.env.NEXT_PUBLIC_CHAIN === 'mainnet-beta' ? "4XcKzy92jkoasQ17TbRCD9xMGhsjZFBJPowWJyfXKuVd" : "8Z7UgKvwfwtax7WjMgCGq61mNpLuJqgwY51yUgS1iAdF"
